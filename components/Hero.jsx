        ...
        >
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
              <svg width={isMobile ? "13" : "12"} height={isMobile ? "13" : "12"} viewBox="0 0 24 24" fill="none"
              ...
              <span style={{
                fontFamily: F_SANS,
                fontSize: isMobile ? '11px' : 'clamp(13px, 1.2vw, 15px)',
